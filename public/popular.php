...
require_once __DIR__ . '/../app/Database/Connection.php';require_once __DIR__ . '/../app/Models/Book.php';
require_once __DIR__ . '/../app/Models/Rating.php';
require_once __DIR__ . '/../app/Models/WishlistItem.php';
require_once __DIR__ . '/../app/Models/User.php';
require_once __DIR__ . '/../app/Models/CartItem.php';require_once __DIR__ . '/../app/Repositories/IBookstoreRepository.php';
...
require_once __DIR__ . '/../app/Controllers/CartController.php';require_once __DIR__ . '/auth_utils.php';
...
use App\Services\ProfileService;try {
...
$wishlistRepository = new WishlistRepository($db, $bookstoreRepository);$wishlistService = new WishlistService($wishlistRepository);

$profileRepository = new ProfileRepository($db);
$profileService = new ProfileService($profileRepository);

$controller = new BookstoreController($bookstoreService, $ratingService);if ($_SERVER['REQUEST_METHOD'] === 'POST') {    error_log("Unhandled POST request to popular.php. Request data: " . file_get_contents('php://input'));
...
if ($phpUserId !== null) {
    try {        $userWishlistItems = $wishlistService->getUserWishlist($phpUserId);
