...
class BookstoreController {
   ...
   public function getRecommendations($genre = '', $descriptionSearch = null, $mood = '') {
        ...
        if (!empty($descriptionSearch)) {
            ...
            error_log("Controller: Added DescriptionSearchSpecification for: " . $descriptionSearch);
        } else {
            error_log("Controller: Description search query is empty or not recognized.");
        }
