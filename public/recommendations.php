...
require_once __DIR__ . '/../app/Controllers/BookstoreController.php';require_once __DIR__ . '/../app/Specifications/SpecificationInterface.php';
...
require_once __DIR__ . '/../app/Specifications/AndSpecification.php';require_once __DIR__ . '/../app/Specifications/DescriptionSearchSpecification.php';
...
$controller = new BookstoreController($bookstoreService, $ratingService);$genre = $_POST['genre'] ?? null;
$mood = $_POST['mood'] ?? null;
$searchQuery = $_POST['search_query'] ?? null;
error_log("DEBUG: recommendations.php - Genre: " . var_export($genre, true));
error_log("DEBUG: recommendations.php - Search Query (Description Keywords): " . var_export($searchQuery, true));error_log("DEBUG: recommendations.php - Mood: " . var_export($mood, true));
$recommended_books = $controller->getRecommendations($genre, $searchQuery, $mood);
?>
