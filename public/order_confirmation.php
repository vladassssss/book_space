...
require_once __DIR__ . '/../app/Models/CartItem.php';require_once __DIR__ . '/../app/Repositories/OrderRepositoryInterface.php';
require_once __DIR__ . '/../app/Repositories/IUserRepository.php';
require_once __DIR__ . '/../app/Repositories/ICartRepository.php';
require_once __DIR__ . '/../app/Repositories/IBookstoreRepository.php';require_once __DIR__ . '/../app/Repositories/OrderRepository.php';
require_once __DIR__ . '/../app/Repositories/UserRepository.php';
require_once __DIR__ . '/../app/Repositories/CartRepository.php';
require_once __DIR__ . '/../app/Repositories/BookstoreRepository.php';require_once __DIR__ . '/../app/Services/OrderServiceInterface.php';
require_once __DIR__ . '/../app/Services/IBookstoreService.php';require_once __DIR__ . '/../app/Services/OrderService.php';
require_once __DIR__ . '/../app/Services/CartService.php';
require_once __DIR__ . '/../app/Services/BookstoreService.php';require_once __DIR__ . '/../app/Controllers/OrderController.php';require_once __DIR__ . '/auth_utils.php';
require_once __DIR__ . '/../app/Database/Connection.php';use App\Database\Connection;
...
use App\Controllers\OrderController;if (!isset($_SESSION['user_id'])) {
...
$userId = $_SESSION['user_id'];$orderRepository = new OrderRepository($db);
$userRepository = new UserRepository($db);
$cartRepository = new CartRepository($db);
$bookstoreRepository = new BookstoreRepository($db);$orderService = new OrderService(
    $orderRepository,    $cartRepository,    $userRepository,    $bookstoreRepository);
$bookstoreService = new BookstoreService($bookstoreRepository);$orderController = new OrderController($orderService, $bookstoreService);$order = $orderController->getOrderDetails((int)$orderId, $userId);

if (!$order) {
    $_SESSION['message'] = "Замовлення не знайдено або у вас немає доступу до нього.";
    header('Location: /bookshop/bookshop/public/index.php');    exit();
}?>
<!DOCTYPE html>
<html lang="uk">
<head>
